require(['config'],function(){
	require(['jquery','common','zoom'],function(){
		$(()=>{
					...
					var goods = JSON.parse(res).map(goods=>{
						...
						<div class="cont w960">
							...
							<div class="goods clearfix">
								<div id="goodsImg"><img src="${goods.imgS}" data-large="${goods.imgL}"></div>
								<div class="goodsInfo">
									<div class="title">
										<h1>${goods.name}</h1>
										<div class="clearfix">
			...
			// 放大镜效果
			$(document).on('mouseover','#goodsImg',function(){
				console.log(233)
			})

			$('#goodsImg').on('mouseover',function(){
				console.log(666)
			})
		});
